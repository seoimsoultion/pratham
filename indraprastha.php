...
<head>
    ...
    <style>
        ...
        .container-fluid.amenities-2nd-row {
            margin-bottom: -93px;
        }
        ...
        .project-detail-ul li:nth-of-type(2) img {
            width: 22px;
        }
        
        .project-detail-ul li:nth-of-type(3) img {
            width: 19px;
        }
...
<body id="top" class="page-load">
    ...
    <div class="color-panel">
        <div class="on-panel color_white" style='background-color:#1e283c;'>
            <div class="text-center icon-spinner">
                <i class="fa fa-envelope fa-3x pop-icon" aria-hidden="true"></i>
            </div>
        </div>
        <div class="panel-box">
    ...
    <div class="sidebar bg_primary desk-banner">
    ...
    <div class="sidebar bg_primary mob-banner">

        <span style="cursor:pointer; background: #1e283c; padding:7px 5px; border-radius: 3px;" onclick="openNav()">&#9776;</span>
	...
	==================================================-->
					...
					<div class="row h-100 align-items-center">
						<div class="col-md-12 col-lg-12 home-content text-left">
							<div class="mainbanner_content">
								<span class="pb_5 banner_title color_white">Indraprastha</span>
								<h1 class="cd-headline clip is-full-width text-uppercase">
									<span class="color_white">A Project By <br /> Pratham Constructor</span>
									<span class="cd-words-wrapper color_default">
        ...
        <div id="amenities" class="section bg_white pp-scrollable">
            <div class="container">
                <div class="services mt_30 desk-banner">
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                ...
                <div id="carousel-example" class="carousel slide mob-banner " data-ride="carousel">
                    <div class="col-md-12 col-lg-12 mt_60">
                        <div class="section_title_1 text-center mx-auto pb_30 wow animated slideInUp">
                            <h2 class="title text-uppercase color_primary" style="padding-top: 15px;">Amenities</h2>
                            <p class="mt_15 text-center color_primary">For the ultimate contemporary lifestyle revolving around health and well-being, Indraprastha offers a multitude of modern amenities.</p>
                        </div>
                    </div>
        ...
        <div id="specifications" class="section bg_white pp-scrollable">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="service_one">
                                ...
                                <ul class='project-detail-ul'>
                                    <li>3 track Aluminium Sliding Windows with provision for mosquito mesh</li>
                            ...
                            <div class="service_one">
                                ...
                                <ul class='project-detail-ul'>
                                    ...
                                    <ul class="ulExtra" id="list_C">
                                        ...
                                        <li>Microwave Point and Water Purifier point at appropriate places in the kitchen</li>
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="service_one">
                                ...
                                <ul class='project-detail-ul'>
                                    <li>EWC – Wall mounted commode of Cera/Hindware/Parryware or equivalent</li>
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="service_one">
                                ...
                                <h3 class="font-weight-bold color_primary  text-center">Electrical POINTS</h3>
                                <ul class='project-detail-ul'>
                                    ...
                                    <ul class="ulExtra" id="list_G">
                                        ...
                                        <li>100% Diesel Generator power back up for common area lighting, lifts,pumps and any other common amenity.</li>
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="service_one">
                                ...
                                <div class='text-center'>
                                    <button class="liReadMore btn btn-default" id="readMore_I" style="margin: 0px;">Show More</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="carousel-example" class="carousel slide mob-banner " data-ride="carousel">
                <div class="col-md-12 col-lg-12 mt_60">
                    <div class="section_title_1 text-center mx-auto pb_30 wow animated slideInUp">
                        <h2 class="title text-uppercase color_primary" style="padding-top: 15px;">Specifications</h2>
                        <p class="mt_15 text-center color_primary">For the ultimate contemporary lifestyle revolving around health and well-being, Indraprastha offers a multitude of modern amenities.</p>
                    </div>
                </div>
                ...
                <div class="carousel-inner row w-100 mx-auto" role="listbox" style="padding-top: 15px;">
                    ...
                    <div class="carousel-item col-md-4 col-lg-4">
                        <div class="service_one">
                            ...
                            <ul class='project-detail-ul'>
                                ...
                                <div class='text-center'>
                                    <button class="liReadMore btn btn-default" id="readMore_J" style="margin: 0px;">Show More</button>
                                </div>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item col-md-4 col-lg-4">
                        <div class="service_one">
                            ...
                            <ul class='project-detail-ul'>
                                ...
                                <div class='text-center'>
                                    <button class="liReadMore btn btn-default" id="readMore_K" style="margin: 0px;">Show More</button>
                                </div>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item col-md-4 col-lg-4">
                        <div class="service_one">
                            ...
                            <ul class='project-detail-ul'>
                                ...
                                <div class='text-center'>
                                    <button class="liReadMore btn btn-default" id="readMore_L" style="margin: 0px;">Show More</button>
                                </div>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item col-md-4 col-lg-4">
                        <div class="service_one">
                            ...
                            <ul class='project-detail-ul'>
                                ...
                                <li>Toilet Ceiling and Wall painted in Emulsion Paint</li>
                                <li>Kitchen – Emulsion paint</li>
                                <ul class="ulExtra" id="list_M">
                                    <li>All fabricated members (balcony grills) painted in synthetic enamel paint</li>
                                    <li>External Walls painted in Weather proof paint</li>
                                </ul>
                                <div class='text-center'>
                                    <button class="liReadMore btn btn-default" id="readMore_M" style="margin: 0px;">Show More</button>
                                </div>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item col-md-4 col-lg-4">
                        <div class="service_one">
                            ...
                            <ul class='project-detail-ul'>
                                ...
                                <li>Toilet Ceiling and Wall painted in Emulsion Paint</li>
                                <li>Kitchen – Emulsion paint</li>
                                <ul class="ulExtra" id="list_N">
                                    <li>All fabricated members (balcony grills) painted in synthetic enamel paint</li>
                                    <li>External Walls painted in Weather proof paint</li>
                                </ul>
                                <div class='text-center'>
                                    <button class="liReadMore btn btn-default" id="readMore_N" style="margin: 0px;">Show More</button>
                                </div>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item col-md-4 col-lg-4">
                        ...
                        <div class="service_one">
                            ...
                            <ul class='project-detail-ul'>
                                ...
                                <div class='text-center'>
                                    <button class="liReadMore btn btn-default" id="readMore_O" style="margin: 0px;">Show More</button>
                                </div>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item col-md-4 col-lg-4">
                        <div class="service_one">
                            ...
                            <div class='text-center'>
                                <button class="liReadMore btn btn-default" id="readMore_P" style="margin: 0px;">Show More</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item col-md-4 col-lg-4">
                        <div class="service_one">
                            ...
                            <div class='text-center'>
                                <button class="liReadMore btn btn-default" id="readMore_Q" style="margin: 0px;">Show More</button>
                            </div>
                        </div>
                    </div>
                </div>
					...
					<div class="row">
						<div class="col-md-12 col-lg-12">
							<div class="team_member owl-carousel">
								<div class="member">
									<img src="images/pratham/indraprastha/children.jpg" alt="image">

									<div class="hover_overlay">
										<div class="border">
											<h4 class="color_default font-weight-bold text-center text-uppercase">Kids Play Area</h4>
											<strong class="color_white text-center d-block mb_15"></strong>
								...
								<div class="member">
									<img src="images/pratham/indraprastha/clubhouse.jpg" alt="image">

									<div class="hover_overlay">
										<div class="border">
											<h4 class="color_default font-weight-bold text-center text-uppercase">Club House</h4>
											<strong class="color_white text-center d-block mb_15"></strong>
											<p class="color_white"></p>
								...
								<div class="member">
									<img src="images/pratham/indraprastha/gym.jpg" alt="image">

									<div class="hover_overlay">
										<div class="border">
											<h4 class="color_default font-weight-bold text-center text-uppercase">Fully Equipped Gym</h4>
											<strong class="color_white text-center d-block mb_15"></strong>
											<p class="color_white"></p>
								...
								<div class="member">
									<img src="images/pratham/indraprastha/jogging.jpg" alt="image">

									<div class="hover_overlay">
										<div class="border">
											<h4 class="color_default font-weight-bold text-center text-uppercase">Paved Jogging Track</h4>
											<strong class="color_white text-center d-block mb_15"></strong>
											<p class="color_white"></p>
								...
								<div class="member">
									<img src="images/pratham/indraprastha/multipurpose.jpg" alt="image">

									<div class="hover_overlay">
										<div class="border">
											<h4 class="color_default font-weight-bold text-center text-uppercase">Multipurpose Hall</h4>
											<strong class="color_white text-center d-block mb_15"></strong>
											<p class="color_white"></p>
								...
								<div class="member">
									<img src="images/pratham/indraprastha/sewage.jpg" alt="image">

									<div class="hover_overlay">
										<div class="border">
											<h4 class="color_default font-weight-bold text-center text-uppercase">Sewage Treatment</h4>
											<strong class="color_white text-center d-block mb_15"></strong>
											<p class="color_white"></p>
								...
								<div class="member">
									<img src="images/pratham/indraprastha/swim.jpg" alt="image">

									<div class="hover_overlay">
										<div class="border">
											<h4 class="color_default font-weight-bold text-center text-uppercase">Swimming Pool</h4>
											<strong class="color_white text-center d-block mb_15"></strong>
											<p class="color_white"></p>
								...
								<div class="member">
									<img src="images/pratham/indraprastha/yoga.jpg" alt="image">

									<div class="hover_overlay">
										<div class="border">
											<h4 class="color_default font-weight-bold text-center text-uppercase">Yoga Center</h4>
											<strong class="color_white text-center d-block mb_15"></strong>
											<p class="color_white"></p>
            ...
            <div class="container">
                <div class="portfolio2 mt_30">
                    <div class="row">
                        ...
                        <div id="mixedSlider">
                            <div class="MS-content desk-banner">
                            ...
                            <div class="MS-content mob-banner">
                                <div class="default-portfolio-item item">
                                    <a href="images/gallery/view-2.jpg" data-fancybox="gallery-fancy">
                                        <img src="images/gallery/view-2.jpg" alt="image" />
                                        <div class="overlay-box">
                                    ...
                                    <a href="images/gallery/view-3.jpg" data-fancybox="gallery-fancy">
                                        <img src="images/gallery/view-3.jpg" alt="image" style="padding-top:25px;" />
                                        <div class="overlay-box">
                                            <span><i class="fa fa-eye" aria-hidden="true"></i></span>
                                ...
                                <div class="default-portfolio-item item">
                                    ...
                                    <a href="images/gallery/view-5.jpg" data-fancybox="gallery-fancy">
                                        <img src="images/gallery/view-5.jpg" alt="image" style="padding-top:25px;" />
                                        <div class="overlay-box">
                                            <span><i class="fa fa-eye" aria-hidden="true"></i></span>
                                ...
                                <div class="default-portfolio-item item">
                                    ...
                                    <a href="images/gallery/view-7.jpg" data-fancybox="gallery-fancy">
                                        <img src="images/gallery/view-7.jpg" alt="image" style="padding-top:25px;" />
                                        <div class="overlay-box">
                                            <span><i class="fa fa-eye" aria-hidden="true"></i></span>
                                ...
                                <div class="default-portfolio-item item">
                                    ...
                                    <a href="images/gallery/view-9.jpg" data-fancybox="gallery-fancy">
                                        <img src="images/gallery/view-9.jpg" alt="image" style="padding-top:25px;" />
                                        <div class="overlay-box">
                                            <span><i class="fa fa-eye" aria-hidden="true"></i></span>
                                ...
                                <div class="default-portfolio-item item">
                                    ...
                                    <a href="images/gallery/view-11.jpg" data-fancybox="gallery-fancy">
                                        <img src="images/gallery/view-11.jpg" alt="image" style="padding-top:25px;" />
                                        <div class="overlay-box">
                                            <span><i class="fa fa-eye" aria-hidden="true"></i></span>
                                ...
                                <div class="default-portfolio-item item">
                                    ...
                                    <a href="images/gallery/view-13.jpg" data-fancybox="gallery-fancy">
                                        <img src="images/gallery/view-13.jpg" alt="image" style="padding-top:25px;" />
                                        <div class="overlay-box">
                                            <span><i class="fa fa-eye" aria-hidden="true"></i></span>
                                ...
                                <div class="default-portfolio-item item">
                                    ...
                                    <a href="images/gallery/view-15.jpg" data-fancybox="gallery-fancy">
                                        <img src="images/gallery/view-15.jpg" alt="image" style="padding-top:25px;" />
                                        <div class="overlay-box">
                                            <span><i class="fa fa-eye" aria-hidden="true"></i></span>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="price_table">
                                <div class="row">
                                    <div class="col-sm-12 mob-banner">
                                        <img src="images/pratham/indraprastha/5-1-mob.jpg" alt="design--room" usemap="#Map" class="master-bottom">
                                    </div>
                                    <div class="col-sm-12 desk-banner">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="main_title ">
                                ...
                                <p class="mt_15  text-center pb_30">Conveniently placed in the heart of Yashwanthpur, enjoy enhanced connectivity and accessibility <br>to the prime centres of the city from Indraprastha. </p>
                            </div>
                            <!--	End Title
		    				================================-->
                        </div>
					...
					<div class="row">
						<div class="price_table" style="margin-bottom: 30px;">
							<div class="row text-center">
								<div class="col-md-12 col-lg-12 col-xs-12" id='mobile'>
								...
								<div class="col-md-6 col-lg-6 col-xs-12" id='desktop'>
									<div class="table text-center" style='border-radius: 20px;padding: 20px;margin: 20px 20px;width:100%'>
										<a href="images/pratham/indraprastha/indraprastha.png" class="desktop" data-fancybox="gallery-fancy">
											<img src="images/pratham/indraprastha/indraprastha-500x300.png" class="img-fluid">
										</a>
									</div>
								</div>									
								<div class="col-md-6 col-lg-6" id='desktop'>
									<div class="table text-center " style='border-radius: 20px;padding: 20px;margin: 20px 20px;width:100%'>
										<a href="https://www.youtube.com/watch?v=wvmP8yaYqsw&feature=youtu.be" class="video-thumb-wrapper desktop" data-fancybox="gallery-fancy">
											<img src="images/pratham/indraprastha/videocover-500x300.jpg" class="img-fluid">
											<img src="images/play.png" class="vimg">
										</a>
									</div>
								</div>
