		...
		<div class="row">
			...
			<div class="col-md-12 col-lg-12">
				<div class="section_title_1 text-center mx-auto pb_60 wow animated slideInUp">
					...
					<p class="sub_title color_white txt-italic text-justify">“Providing the communities we serve with superior products and services by developing innovative
		...
		<div class="row">
			...
			<div class="col-md-12 col-lg-12">
				<div class="section_title_1 text-center mx-auto pb_60 wow animated slideInUp">
					...
					<p class="sub_title text-justify">At Pratham Consructions, we value talent, hard work and development at both professional and personal level. In all our aspirations, we are open to hiring the best brains to ensure maximum productivity and capitalise on human resources. </p>
				</div>
			</div>
