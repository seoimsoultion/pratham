			...
			<div class="row">
				<div class="col-md-7 col-lg-7">
					...
					<div class="personal_info color_lightgray">
											<ul>
												...
												<li><span class="color_secondery"></span> Indraprastha Bengaluru's
				...
				<div class="col-md-5 col-lg-5">
					<div class="profile_img personal_video wow animated fadeInRight">
						...
						<div class="iconround"><a class="video-popup" href="https://www.youtube.com/watch?v=U16kL-npP9s" title="video popup">
						...
						<div class="col-md-4 col-lg-4">
							<div class="counter count wow text-center" data-wow-duration="300ms">
								...
								<div class="counting_digit color_default mt_15">
									<h2 class="count-num" data-speed="3000" data-stop="7">0</h2><span>+</span>
								</div>
